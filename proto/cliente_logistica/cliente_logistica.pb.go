...
func (x *EnvioRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EnvioRequest) ProtoMessage() {}

func (x *EnvioRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_cliente_logistica_proto_msgTypes[0]
...
// Deprecated: Use EnvioRequest.ProtoReflect.Descriptor instead.
func (*EnvioRequest) Descriptor() ([]byte, []int) {
	return file_proto_cliente_logistica_proto_rawDescGZIP(), []int{0}
}

func (x *EnvioRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *EnvioRequest) GetProducto() string {
	if x != nil {
		return x.Producto
	}
	return ""
...
func (x *EnvioRequest) GetValor() int64 {
	if x != nil {
		return x.Valor
	}
	return 0
...
func (x *EnvioRequest) GetTienda() string {
	if x != nil {
		return x.Tienda
	}
	return ""
...
func (x *EnvioRequest) GetDestino() string {
	if x != nil {
		return x.Destino
	}
	return ""
...
func (x *EnvioResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EnvioResponse) ProtoMessage() {}

func (x *EnvioResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_cliente_logistica_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EnvioResponse.ProtoReflect.Descriptor instead.
func (*EnvioResponse) Descriptor() ([]byte, []int) {
	return file_proto_cliente_logistica_proto_rawDescGZIP(), []int{1}
}

func (x *EnvioResponse) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
var file_proto_cliente_logistica_proto_rawDesc = []byte{
	...
	0x63, 0x61, 0x22, 0x82, 0x01, 0x0a, 0x0c, 0x45, 0x6e, 0x76, 0x69, 0x6f, 0x52, 0x65, 0x71, 0x75,
	...
	,
}
...
var file_proto_cliente_logistica_proto_depIdxs = []int32{
	2, // 0: cliente_logistica.SeguimientoService.Seguimiento:input_type -> cliente_logistica.SeguimientoRequest
	0, // 1: cliente_logistica.EnvioService.Envio:input_type -> cliente_logistica.EnvioRequest
	3, // 2: cliente_logistica.SeguimientoService.Seguimiento:output_type -> cliente_logistica.SeguimientoResponse
	1, // 3: cliente_logistica.EnvioService.Envio:output_type -> cliente_logistica.EnvioResponse
...
// EnvioServiceClient is the client API for EnvioService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
...
func NewEnvioServiceClient(cc grpc.ClientConnInterface) EnvioServiceClient {
	return &envioServiceClient{cc}
}

func (c *envioServiceClient) Envio(ctx context.Context, in *EnvioRequest, opts ...grpc.CallOption) (*EnvioResponse, error) {
	out := new(EnvioResponse)
	err := c.cc.Invoke(ctx, "/cliente_logistica.EnvioService/Envio", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UnimplementedEnvioServiceServer struct {
}
...
func RegisterEnvioServiceServer(s *grpc.Server, srv EnvioServiceServer) {
	s.RegisterService(&_EnvioService_serviceDesc, srv)
}

func _EnvioService_Envio_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EnvioRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EnvioServiceServer).Envio(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cliente_logistica.EnvioService/Envio",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EnvioServiceServer).Envio(ctx, req.(*EnvioRequest))
	}
	return interceptor(ctx, in, info, handler)
}
